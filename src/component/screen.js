    ...
    <div className="mx-auto gap-4 w-full bg-slate-800 min-h-screen">
      ...
      <div className="grid  grid-cols-12">
        ...
        <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Filter By</label>
            <hr class="h-px w-32 bg-gray-200 border-0 dark:bg-gray-700"></hr>
          <Sidebar />
        </div>
        <div className="col-span-10 pl-2 w-full sm:col-span-10 rounded-lg border border-black bg-slate-800">
        <div class=" pt-2 w-full inline-flex pl-3 justify-between text-sm text-white">
        <div className="text-white text-base inline-flex pt-6 ">SEARCH RESULTS/JOBS-{searchResults.length}</div>
       
        <div class=" pt-3 flex-1 inline-flex place-items-center pr-4 flex-end justify-end">
        <button
