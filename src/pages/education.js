...
function Education() {
  function Institution({ name, img, year, std, location ,place,website,percentege}) {
    return (
      <div className="border-2 border-red-300 p-4 lg:w-[1024px] hover hover:bg-slate-200  ">
        ...
        <div className="flex md:flex-row lg:flex-row flex-col  gap-10">
          <div>
            ...
            <img
              className="avatar border-2 border-lime-400"
              src={img}
              width="500"
              height="500"
